...
/// 协议编号定义
/// </summary>
public class ProtoCodeDefine
{

    #region 本地测试使用
    public const ushort TEST = 8888;
    #endregion
    /// <summary>
    /// 客户端发送本地时间
    /// </summary>
    ...
    /// 客户端发送登录区服消息
    /// </summary>
    public const ushort Account_LoginGameServerReqProto = 10001;

    /// <summary>
    /// 服务器返回登录信息
    /// </summary>
    public const ushort Account_LoginGameServerRespProto = 10002;

    /// <summary>
    /// 客户端发送创建角色消息
    /// </summary>
    public const ushort Account_AddRoleReqProto = 10003;

    /// <summary>
    /// 服务器返回创建角色消息
    /// </summary>
    public const ushort Account_AddRoleRespProto = 10004;

    /// <summary>
    /// 客户端发送删除角色消息
    /// </summary>
    public const ushort Account_DeleteRoleReqProto = 10005;

    /// <summary>
    /// 服务器返回删除角色消息
    /// </summary>
    public const ushort Account_DeleteRoleRespProto = 10006;

    /// <summary>
    /// 客户端发送进入游戏消息
    /// </summary>
    public const ushort Account_EnterGameReqProto = 10007;

    /// <summary>
    /// 服务器返回进入游戏消息
    /// </summary>
    public const ushort Account_EnterGameRespProto = 10008;

    /// <summary>
    /// 客户端查询角色信息
    /// </summary>
    public const ushort Account_RoleInfoReqProto = 10009;

    /// <summary>
    /// 服务器返回角色信息
    /// </summary>
    public const ushort Account_RoleInfoRespProto = 10010;
