...
public class Leo_UIWindowBase : Leo_UIBase {
    ...
    /// </summary>
    protected UIWindowType mNextWindow = UIWindowType.NONE;
    ...
    {
        if (mNextWindow.Equals(UIWindowType.NONE)) return;
        Leo_UIWindowManager.Instance.OpenWindowUI(mNextWindow);
